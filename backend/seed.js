...
const data = {
  ...
  events: [
    ...
    { id: 'E002', organizerId: 'U001', venueId: 'V003', name: 'Founders Sunset Forum', type: 'Networking', date: '2026-07-22', status: 'Confirmed', dressCode: 'Business casual', agenda: '6:00 reception, 7:00 panel, 8:30 networking', expectedGuests: 75, plannedBudget: 92000 }
  ],
  bookingRequests: [
    { id: 'B001', organizerId: 'U001', venueId: 'V001', eventName: 'Nile Makers Night', eventDate: '2026-07-10', attendees: 140, status: 'Approved', message: 'Need terrace access and projector.', counterProposal: '' },
    { id: 'B002', organizerId: 'U001', venueId: 'V002', eventName: 'Design Supply Expo', eventDate: '2026-07-20', attendees: 230, status: 'Pending', message: 'Requesting stage and loading access.', counterProposal: '' }
  ],
  tasks: [
    { id: 'T001', eventId: 'E001', title: 'Confirm welcome desk tablets', speciality: 'Guest Experience', assigneeId: 'U003', status: 'In Progress', dueDate: '2026-07-07', reminderSent: false },
    { id: 'T002', eventId: 'E001', title: 'Mark vendor loading route', speciality: 'Logistics', assigneeId: 'U002', status: 'Pending', dueDate: '2026-07-08', reminderSent: false },
    { id: 'T003', eventId: 'E002', title: 'Prepare rooftop seating map', speciality: 'Seating', assigneeId: '', status: 'Not Assigned', dueDate: '2026-07-18', reminderSent: false }
  ],
  budgetItems: [
    { id: 'P001', eventId: 'E001', category: 'Venue', planned: 42000, actual: 42000 },
    { id: 'P002', eventId: 'E001', category: 'Catering', planned: 52000, actual: 48600 },
    { id: 'P003', eventId: 'E001', category: 'Production', planned: 36000, actual: 40250 },
    { id: 'P004', eventId: 'E001', category: 'Marketing', planned: 25000, actual: 21400 }
  ],
  vendors: [
    { id: 'VN001', userId: 'U004', companyName: 'Cairo Bloom Catering', supplies: ['Canapes', 'Beverages', 'Dessert station'], location: 'Maadi', pricing: 'From 380 EGP per guest', contact: '0100-555-1400', rating: 4.7 },
  ...
  feedback: [
    { id: 'F001', eventId: 'E001', guestId: 'G001', overall: 5, food: 4, venue: 5, organization: 5, comments: 'Smooth check-in and lovely venue.' },
    { id: 'F002', eventId: 'E001', guestId: 'G003', overall: 4, food: 5, venue: 4, organization: 4, comments: 'Great experience, signs could be larger.' }
  ],
  layouts: [{ id: 'L001', eventId: 'E001', name: 'Glasshouse Main Layout', elements: [
    { id: 'LE001', type: 'Stage', x: 64, y: 36 }, { id: 'LE002', type: 'Buffet', x: 18, y: 64 }, { id: 'LE003', type: 'Welcome Desk', x: 76, y: 72 }, { id: 'LE004', type: 'Seating', x: 46, y: 56 }
  ] }]
};
writeDb(data);
console.log('Seeded Layali Events dummy data.');
